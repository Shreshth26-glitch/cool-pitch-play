...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "frostPitch — Premium Box Cricket in Bhilwara" },
      ...
      { name: "author", content: "frostPitch" },
      { name: "theme-color", content: "#0a1512" },
      { property: "og:title", content: "frostPitch — Where Champions Play" },
      ...
      { name: "twitter:title", content: "frostPitch — Where Champions Play" },
